...
host_layout = [[gui.Text("Image"), gui.Input(size=(50, 11), key="host_image"),
               ...
               [gui.Text("Piece Count"), gui.Input("1000", size=(6, 1), key="host_piece_count")],
...
window = gui.Window("Rompecabezas", tabs)
...
while True:
    ...
    if event == gui.WIN_CLOSED:
        ...
        args = [values["host_piece_count"], "-s", values["host_image"], "-p", values["host_port"]]
        window.close()
        run(args)
        break
    elif event == "offline":
